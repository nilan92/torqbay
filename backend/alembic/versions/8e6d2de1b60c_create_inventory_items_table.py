...
def upgrade() -> None:
    ...
    sa.Column('quantity_on_hand', sa.Float(precision=53), server_default='0', nullable=False),
    sa.Column('reorder_threshold', sa.Float(precision=53), server_default='0', nullable=False),
